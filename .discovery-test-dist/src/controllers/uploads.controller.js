...
const uploadsService = __importStar(require("../services/uploads.service"));
async function uploadCover(request, response) {
...
async function uploadPanel(request, response) {
