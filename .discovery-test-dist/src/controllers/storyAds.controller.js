...
const storyAdsService = __importStar(require("../services/storyAds.service"));
async function getActiveAd(_request, response) {
    response.json({ data: await storyAdsService.getActiveAd() });
}
async function recordImpression(request, response) {
...
async function recordClick(request, response) {
