...
exports.requireGenre = requireGenre;
exports.findGenreId = findGenreId;
const genresRepository = __importStar(require("../repositories/genres.repository"));
const ApiError_1 = require("../utils/ApiError");
function listGenres() {
    return genresRepository.listGenres();
}
async function requireGenre(name) {
    const genre = await genresRepository.findByName(name);
    if (!genre)
        throw new ApiError_1.ApiError(400, 'Genre is not supported');
    return genre;
}
